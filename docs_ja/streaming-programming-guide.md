...
- <!-- en -->
  ...
  *ライト・アヘッド・ログの設定* - Spark 1.2 から
  ...
  にすることで行えます。
  一方、_ライトアヘッドログ_のために S3 を使っている場合、忘れずに
  `spark.streaming.driver.writeAheadLog.closeFileAfterWrite` と
  `spark.streaming.receiver.writeAheadLog.closeFileAfterWrite`
  を有効にしてください。
  詳細については
  [Spark Streaming Configuration](configuration.html#spark-streaming)
  を参照してください。
  <!-- /ja -->
...
## Monitoring Applications // アプリケーションの監視
...
## Reducing the Batch Processing Times // バッチ処理時間の節減
...
## Setting the Right Batch Interval // 適切なバッチ・インターバルの設定
...
# Migration Guide from 0.9.1 or below to 1.x // 0.9.1 以下から 1.x へのマイグレーションガイド
